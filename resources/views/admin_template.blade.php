    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div style="float:left; padding: 0;">
            <ol class="breadcrumb hidden-xs" style="margin-bottom:0;margin-top:7px;">
                 <li class="active">
                   <a href="http://localhost/voyagerdemo/public/admin"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                 <li class="active"><a href="http://localhost/voyagerdemo/public/admin/users">Users</a></li>
                 <li>Edit</li>
            </ol>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="btn-group" style="float:right">
                      <a class="btn btn-info btn-sm"><i class="glyphicon glyphicon-th-list"></i> 列表</a>
                      ...
                      <a  class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-search"></i> 筛选</a>
      </div>
      </h1>
